...
public class AdapterProductsHorizontal extends RecyclerView.Adapter<AdapterProductsHorizontal.HolderProducts>{
    ...
    public AdapterProductsHorizontal(Context context, ArrayList<ModelProducts> productsArrayList, Fragment fragment) {
        this.context = context;
        this.productsArrayList = productsArrayList;
        this.fragment = fragment;
        try{ this.preferenceManager = new preferenceManager(context);}catch (Exception e){}
    }
    ...
    public HolderProducts onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_products_horizontal, parent, false);
        return new HolderProducts(view);
    }


    @Override
    public void onBindViewHolder(@NonNull @NotNull AdapterProductsHorizontal.HolderProducts holder, int position) {
    ...
    public class HolderProducts extends RecyclerView.ViewHolder {
        ...
        TextView discountPercent, productName, sellingPrise, mrpPrise, quentity, addBtn, itemCount, outOfStock;
        ImageView productImg, imageMinus, imageAddOne;
